...
{
    public partial class NonSingle : Form
    {
        public readonly int newUserId;
        private readonly Cart _cart;
        private decimal _basePrice;
        private int _nights;
        public NonSingle(int userId, Cart cart)
        {
            InitializeComponent();
            newUserId = userId;
        ...
        private void NonSingle_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            _cart.RoomType = "Single Bed Non AC Room";
