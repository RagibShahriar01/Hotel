...
{
    public partial class NonTriple : Form
    {
        public readonly int newUserId;
        private readonly Cart _cart;
        private decimal _basePrice;
        private int _nights;
        public NonTriple(int userId, Cart cart)
        {
            InitializeComponent();
            newUserId = userId;
        ...
        private void NonTriple_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            _cart.RoomType = "Triple Bed Non AC Room";
