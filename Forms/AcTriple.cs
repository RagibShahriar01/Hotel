...
{
    public partial class AcTriple : Form
    {
        ...
        public AcTriple(int userId, Cart cart)
        {
            InitializeComponent();
            newUserId = userId;
        ...
        private void AcTriple_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            _cart.RoomType = "Single Triple Bed AC Room";
