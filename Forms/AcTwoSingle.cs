...
{
    public partial class AcTwoSingle : Form
    {
        ...
        private int _nights;
        public AcTwoSingle(int userId, Cart cart)
        {
            InitializeComponent();
            newUserId = userId;
        ...
        private void AcTwoSingle_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            _cart.RoomType = "Two Single Bed AC Room";
