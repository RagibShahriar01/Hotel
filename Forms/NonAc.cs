...
{
    public partial class NonAc : Form
    {

        private readonly Cart _cart;
        private readonly int newUserId;
        private readonly DatabaseHelper _db = new DatabaseHelper();
        public NonAc(int userId, Cart cart)
        {
            InitializeComponent();
        ...
        private void RuipictureBox_Click(object sender, EventArgs e)
        {
            ...
            new NonDouble(newUserId, _cart).Show();
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            this.Hide();
            this.TopLevelControl.Hide();
            new NonTwoSingle(newUserId, _cart).Show();
        }
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            this.Hide();
            this.TopLevelControl.Hide();
            new NonTriple(newUserId, _cart).Show();
        }
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            this.Hide();
            this.TopLevelControl.Hide();
            new NonTwoDouble(newUserId, _cart).Show();
        }
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            this.Hide();
            this.TopLevelControl.Hide();
            new NonSingle(newUserId, _cart).Show();
        }

        private void NonAc_Load(object sender, EventArgs e)
        {
            UpdateAvailability();
        }
