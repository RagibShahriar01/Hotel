...
{
    public partial class NonDouble : Form
    {
        public readonly int newUserId;
        private readonly Cart _cart;
        private decimal _basePrice;
        private int _nights;
        public NonDouble(int userId, Cart cart)
        {
            InitializeComponent();
            newUserId = userId;
        ...
        private void NonDouble_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            _cart.RoomType = "Double Bed Non AC Room";
