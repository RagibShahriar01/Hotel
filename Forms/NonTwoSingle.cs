...
{
    public partial class NonTwoSingle : Form
    {
        public readonly int newUserId;
        private readonly Cart _cart;
        private decimal _basePrice;
        private int _nights;
        public NonTwoSingle(int userId, Cart cart)
        {
            InitializeComponent();
            newUserId = userId;
        ...
        private void NonTwoSingle_Load(object sender, EventArgs e)
        {
        ...
        private void BtnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            _cart.RoomType = "Two Single Bed Non AC Room";
